...
export const Cog6ToothIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.962a8.97 8.97 0 015.71 5.71c.046.55-.422 1.02-.962 1.11l-1.591.318a2.25 2.25 0 00-1.85 1.85l-.318 1.591c-.09.542-.56 1.007-1.11.962a8.97 8.97 0 01-5.71-5.71c-.046-.55.422-1.02.962-1.11l1.591-.318a2.25 2.25 0 001.85-1.85l.318-1.591zM12 9a3 3 0 100 6 3 3 0 000-6z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a8.966 8.966 0 01-5.982-1.518c-.32-.184-.623-.394-.905-.625a8.97 8.97 0 01-2.122-5.982c.184-.32.394-.623.625-.905a8.97 8.97 0 015.982-2.122c.32.184.623.394.905.625a8.97 8.97 0 012.122 5.982c-.184.32-.394.623-.625.905A8.966 8.966 0 0112 21z" />
  </svg>
);
...
export const UserGroupIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM3 13.239a3.75 3.75 0 012.754-3.712 3.75 3.75 0 017.5 0 3.75 3.75 0 012.754 3.712 9.096 9.096 0 01-9.26 3.712 9.09 9.09 0 01-6.442-3.712z" />
    </svg>
);
...
export const BuildingStorefrontIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0114.25 12h.01a.75.75 0 01.75.75v7.5m-8.25-9.75h2.523a.75.75 0 01.674.443l.286.715a.75.75 0 00.674.443h2.523a.75.75 0 00.674-.443l.286-.715a.75.75 0 01.674-.443h2.523a.75.75 0 01.674.443l.286.715a.75.75 0 00.674.443h.01M3.75 12h16.5M3.75 5.25h16.5M3.75 8.25h16.5M4.5 12v7.5a.75.75 0 00.75.75h13.5a.75.75 0 00.75-.75V12m0-3.75a.75.75 0 00-.75-.75H4.5a.75.75 0 00-.75.75M12 12h.01" />
    </svg>
);

export const TableCellsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 6.375h17.25M3.375 12h17.25m-17.25 5.625h17.25M3.375 12v9.75A1.125 1.125 0 004.5 23.25h15A1.125 1.125 0 0020.625 22.125V12m-17.25 0V1.875A1.125 1.125 0 014.5.75h15A1.125 1.125 0 0120.625 1.875V12m-7.5 0V2.25" />
    </svg>
);
...
export const ShoppingCartIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.343 1.087-.835l1.823-6.841a.75.75 0 00-.69-.922H5.032l-.23-1.087M15 11.25a.75.75 0 01.75-.75h2.25a.75.75 0 010 1.5h-2.25a.75.75 0 01-.75-.75z" />
  </svg>
);
